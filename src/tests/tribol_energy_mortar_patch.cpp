...
TEST( EnergyMortarResidualGapCheck, AssembledGapIsShiftedByArea )
{
  ...
  evaluator_without_residual.compute_gtilde_and_area( tribol::InterfacePair( 0, 0 ), mesh1.getView(), mesh2.getView(),
                                                      g0, area0 );
...
TEST( EnergyMortarResidualGapCheck, QuadraturePointOpenGapBecomesActive )
{
  ...
  tribol::EnergyMortarCalculator evaluator_without_residual( params );
  const auto inactive =
      evaluator_without_residual.compute_quadrature_point_penalty_data( tribol::InterfacePair( 0, 0 ), mesh1.getView(),
                                                                        mesh2.getView() );
  ...
  tribol::EnergyMortarCalculator evaluator_with_residual( params );
  const auto active =
      evaluator_with_residual.compute_quadrature_point_penalty_data( tribol::InterfacePair( 0, 0 ), mesh1.getView(),
                                                                     mesh2.getView() );
