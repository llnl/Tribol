...
TEST_F( TetMeshTest, build_and_check_tet_mesh )
{
  ...
  this->m_mesh.setupContactMeshTet( nElemsXM, nElemsYM, nElemsZM, x_min1, y_min1, z_min1, x_max1, y_max1, z_max1,
  ...
  EXPECT_EQ( this->m_mesh.numNonmortarNodes,
             ( nNonmortarElems + 1 ) * ( nNonmortarElems + 1 ) * ( nNonmortarElems + 1 ) );
