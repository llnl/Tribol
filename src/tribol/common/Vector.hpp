...
#ifndef TRIBOL_COMMON_VECTOR_HPP_
#define TRIBOL_COMMON_VECTOR_HPP_
...
class Vector {
 ...
 public:
  ...
  using __trivially_relocatable _LIBCPP_NODEBUG =
      std::__conditional_t<std::__libcpp_is_trivially_relocatable<pointer>::value &&
                               std::__libcpp_is_trivially_relocatable<allocator_type>::value,
                           Vector, void>;

  static_assert( std::__check_valid_allocator<allocator_type>::value, "" );
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI Vector()
      _NOEXCEPT_( std::is_nothrow_default_constructible<allocator_type>::value )
  {
  }
  ...
  template <std::__enable_if_t<std::__is_allocator<_Allocator>::value, int> = 0>
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI Vector( size_type __n, const value_type& __x,
  ...
  template <class _InputIterator,
            std::__enable_if_t<
                std::__has_exactly_input_iterator_category<_InputIterator>::value &&
  ...
  template <class _ForwardIterator,
            std::__enable_if_t<std::__has_forward_iterator_category<_ForwardIterator>::value &&
                                   std::is_constructible<
                                       value_type, typename std::iterator_traits<_ForwardIterator>::reference>::value,
                               int> = 0>
 ...
 public:
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI Vector( std::initializer_list<value_type> __il )
  {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI Vector& operator=( std::initializer_list<value_type> __il )
  {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI Vector& operator=( Vector&& __x )
      _NOEXCEPT_( std::__noexcept_move_assign_container<_Allocator, __alloc_traits>::value )
  {
    __move_assign( __x, std::integral_constant<bool, __alloc_traits::propagate_on_container_move_assignment::value>() );
    return *this;
  }
...
#ifndef _LIBCPP_CXX03_LANG
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void assign( std::initializer_list<value_type> __il )
  {
    assign( __il.begin(), __il.end() );
  }
#endif
  ...
  {
    return std::min<size_type>( __alloc_traits::max_size( this->__alloc_ ),
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI iterator insert( const_iterator __position, size_type __n,
                                                                       const_reference __x );
  ...
  template <class _InputIterator,
            std::__enable_if_t<
                std::__has_exactly_input_iterator_category<_InputIterator>::value &&
                    std::is_constructible<value_type, typename std::iterator_traits<_InputIterator>::reference>::value,
                int> = 0>
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI iterator insert( const_iterator __position,
 ...
 private:
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __init_with_size( _InputIterator __first, _Sentinel __last,
                                                                             size_type __n )
  {
    auto __guard = std::__make_exception_guard( __destroy_vector( *this ) );
  ...
  template <class _InputIterator, class _Sentinel>
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __init_with_sentinel( _InputIterator __first,
                                                                                 _Sentinel __last )
  {
    auto __guard = std::__make_exception_guard( __destroy_vector( *this ) );
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __assign_with_sentinel( _Iterator __first,
                                                                                   _Sentinel __last );
  ...
  template <class _Iterator, class _Sentinel>
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __assign_with_size( _Iterator __first, _Sentinel __last,
                                                                               difference_type __n );

  template <class _InputIterator, class _Sentinel>
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI iterator __insert_with_sentinel( const_iterator __position,
                                                                                       _InputIterator __first,
                                                                                       _Sentinel __last );

  template <class _Iterator, class _Sentinel>
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI iterator __insert_with_size( const_iterator __position,
                                                                                   _Iterator __first, _Sentinel __last,
                                                                                   difference_type __n );
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI iterator __make_iter( pointer __p ) _NOEXCEPT
  {
    ...
    // a laxer approach.
    return std::__make_bounded_iter( std::__wrap_iter<pointer>( __p ), std::__wrap_iter<pointer>( this->__begin_ ),
...
#ifdef _LIBCPP_ABI_BOUNDED_ITERATORS_IN_VECTOR
    // Bound the iterator according to the capacity, rather than the size.
    return std::__make_bounded_iter( std::__wrap_iter<const_pointer>( __p ),
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __swap_out_circular_buffer(
      std::__split_buffer<value_type, allocator_type&>& __v );
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI pointer
  __swap_out_circular_buffer( std::__split_buffer<value_type, allocator_type&>& __v, pointer __p );
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __move_range( pointer __from_s, pointer __from_e,
                                                                         pointer __to );
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __move_assign( Vector& __c, std::true_type )
      _NOEXCEPT_( std::is_nothrow_move_assignable<allocator_type>::value );
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __move_assign( Vector& __c, std::false_type )
  ...
  {
    __copy_assign_alloc(
        __c, std::integral_constant<bool, __alloc_traits::propagate_on_container_copy_assignment::value>() );
  }
  ...
  {
    __move_assign_alloc(
        __c, std::integral_constant<bool, __alloc_traits::propagate_on_container_move_assignment::value>() );
  }
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __copy_assign_alloc( const Vector& __c, std::true_type )
  {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __copy_assign_alloc( const Vector&, std::false_type ) {}

  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __move_assign_alloc( Vector& __c, std::true_type )
      _NOEXCEPT_( std::is_nothrow_move_assignable<allocator_type>::value )
  {
    this->__alloc_ = std::move( __c.__alloc_ );
  }

  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void __move_assign_alloc( Vector&, std::false_type ) _NOEXCEPT {}

  template <class _Ptr = pointer, std::__enable_if_t<std::is_pointer<_Ptr>::value, int> = 0>
...
#if _LIBCPP_STD_VER >= 17
template <class _InputIterator, class _Alloc = std::allocator<std::__iter_value_type<_InputIterator>>,
          class = std::enable_if_t<std::__has_input_iterator_category<_InputIterator>::value>,
          class = std::enable_if_t<std::__is_allocator<_Alloc>::value>>
Vector( _InputIterator, _InputIterator ) -> Vector<std::__iter_value_type<_InputIterator>, _Alloc>;

template <class _InputIterator, class _Alloc,
          class = std::enable_if_t<std::__has_input_iterator_category<_InputIterator>::value>,
          class = std::enable_if_t<std::__is_allocator<_Alloc>::value>>
Vector( _InputIterator, _InputIterator, _Alloc ) -> Vector<std::__iter_value_type<_InputIterator>, _Alloc>;
#endif

#if _LIBCPP_STD_VER >= 23
template <ranges::input_range _Range, class _Alloc = allocator<ranges::range_value_t<_Range>>,
...
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::__swap_out_circular_buffer(
    std::__split_buffer<value_type, allocator_type&>& __v )
{
  __annotate_delete();
  auto __new_begin = __v.__begin_ - ( __end_ - __begin_ );
  std::__uninitialized_allocator_relocate( this->__alloc_, std::__to_address( __begin_ ), std::__to_address( __end_ ),
                                                     ...
                                                     pointer __p )
{
  ...
  std::__uninitialized_allocator_relocate( this->__alloc_, std::__to_address( __p ), std::__to_address( __end_ ),
                                           std::__to_address( __v.__end_ ) );
  __v.__end_ += ( __end_ - __p );
  __end_ = __p;  // The objects in [__p, __end_) have been destroyed by relocating them.
  auto __new_begin = __v.__begin_ - ( __p - __begin_ );

  std::__uninitialized_allocator_relocate( this->__alloc_, std::__to_address( __begin_ ), std::__to_address( __p ),
                                           std::__to_address( __new_begin ) );
  __v.__begin_ = __new_begin;
  __end_ = __begin_;  // All the objects have been destroyed by relocating them.
...
template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 inline void Vector<_Tp, _Allocator>::__construct_at_end( size_type __n,
                                                                                       const_reference __x )
{
  _ConstructTransaction __tx( *this, __n );
  const_pointer __new_end = __tx.__new_end_;
...
template <class _Tp, class _Allocator>
template <class _InputIterator, class _Sentinel>
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::__construct_at_end( _InputIterator __first,
                                                                                _Sentinel __last, size_type __n )
{
  _ConstructTransaction __tx( *this, __n );
  __tx.__pos_ =
      std::__uninitialized_allocator_copy( this->__alloc_, std::move( __first ), std::move( __last ), __tx.__pos_ );
}
...
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::__append( size_type __n )
{
  if ( static_cast<size_type>( this->__cap_ - this->__end_ ) >= __n )
    ...
    std::__split_buffer<value_type, allocator_type&> __v( __recommend( size() + __n ), size(), this->__alloc_ );
...
template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 inline _LIBCPP_HIDE_FROM_ABI Vector<_Tp, _Allocator>::Vector(
    Vector&& __x, const std::__type_identity_t<allocator_type>& __a )
    : __alloc_( __a )
{
  if ( __a == __x.__alloc_ ) {
    this->__begin_ = __x.__begin_;
    ...
    typedef std::move_iterator<iterator> _Ip;
    __init_with_size( _Ip( __x.begin() ), _Ip( __x.end() ), __x.size() );
  }
}

template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::__move_assign( Vector& __c, std::false_type )
    _NOEXCEPT_( __alloc_traits::is_always_equal::value )
{
  if ( this->__alloc_ != __c.__alloc_ ) {
    typedef std::move_iterator<iterator> _Ip;
    ...
    __move_assign( __c, std::true_type() );
}

template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::__move_assign( Vector& __c, std::true_type )
    _NOEXCEPT_( std::is_nothrow_move_assignable<allocator_type>::value )
{
  __vdeallocate();
...
template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 inline _LIBCPP_HIDE_FROM_ABI Vector<_Tp, _Allocator>& Vector<_Tp, _Allocator>::operator=(
    const Vector& __x )
{
...
template <class _Tp, class _Allocator>
template <class _Iterator, class _Sentinel>
_LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void Vector<_Tp, _Allocator>::__assign_with_sentinel(
    _Iterator __first, _Sentinel __last )
{
  pointer __cur = __begin_;
  for ( ; __first != __last && __cur != __end_; ++__first, (void)++__cur ) *__cur = *__first;
  if ( __cur != __end_ ) {
...
template <class _Tp, class _Allocator>
template <class _Iterator, class _Sentinel>
_LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void Vector<_Tp, _Allocator>::__assign_with_size(
    _Iterator __first, _Sentinel __last, difference_type __n )
{
...
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::reserve( size_type __n )
{
  if ( __n > capacity() ) {
    ...
    std::__split_buffer<value_type, allocator_type&> __v( __n, size(), this->__alloc_ );
    __swap_out_circular_buffer( __v );
  }
}
...
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::shrink_to_fit() _NOEXCEPT
{
  if ( capacity() > size() ) {
    ...
    try {
      ...
      std::__split_buffer<value_type, allocator_type&> __v( size(), size(), this->__alloc_ );
      // The Standard mandates shrink_to_fit() does not increase the capacity.
      // With equal capacity keep the existing buffer. This avoids extra work
      // due to swapping the elements.
      if ( __v.capacity() < capacity() ) __swap_out_circular_buffer( __v );
#if _LIBCPP_HAS_EXCEPTIONS
    } catch ( ... ) {
    }
#endif  // _LIBCPP_HAS_EXCEPTIONS
...
{
  std::__split_buffer<value_type, allocator_type&> __v( __recommend( size() + 1 ), size(), this->__alloc_ );
    ...
    Vector<_Tp, _Allocator>::emplace_back( _Args&&... __args )
{
  ...
  if ( __end < this->__cap_ ) {
    ::new ( static_cast<void*>( __end ) ) _Tp( std::forward<_Args>( __args )... );
    ...
    pointer __v__cap_;
    {
      auto __allocation = std::__allocate_at_least( this->__alloc_, __recommend( size() + 1 ) );
      __v__first_ = __allocation.ptr;
      __v__cap_ = __v__first_ + __allocation.count;
    }
    pointer __v__end_ = __v__first_ + size();
    pointer __v__begin_ = __v__end_;
    // end fake split_buffer
    //    __v.emplace_back(std::forward<_Args>(__args)...);
    __alloc_traits::construct( this->__alloc_, std::__to_address( __v__end_ ), std::forward<_Args>( __args )... );
    __v__end_++;
    //
    auto __new_begin = __v__begin_ - ( __end_ - __begin_ );
    // ++__new_end;
    // auto __new_cap = __new_begin + __allocation.count;
    std::__uninitialized_allocator_relocate( this->__alloc_, __begin_, __end_, __new_begin );
    __v__begin_ = __new_begin;
    __end_ = __begin_;
    std::swap( this->__begin_, __v__begin_ );
    std::swap( this->__end_, __v__end_ );
    std::swap( this->__cap_, __v__cap_ );
    __v__first_ = __v__begin_;
    //
    __end = this->__end_;
...
template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 typename Vector<_Tp, _Allocator>::iterator Vector<_Tp, _Allocator>::erase(
...
template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 void Vector<_Tp, _Allocator>::__move_range( pointer __from_s, pointer __from_e,
                                                                          pointer __to )
{
...
template <class _Tp, class _Allocator>
_LIBCPP_CONSTEXPR_SINCE_CXX20 typename Vector<_Tp, _Allocator>::iterator Vector<_Tp, _Allocator>::insert(
    const_iterator __position, const_reference __x )
{
  ...
  if ( this->__end_ < this->__cap_ ) {
    ...
    std::__split_buffer<value_type, allocator_type&> __v( __recommend( size() + 1 ), __p - this->__begin_,
                                                          this->__alloc_ );
...
template <class _Tp, class _Allocator>
template <class... _Args>
_LIBCPP_CONSTEXPR_SINCE_CXX20 typename Vector<_Tp, _Allocator>::iterator Vector<_Tp, _Allocator>::emplace(
    const_iterator __position, _Args&&... __args )
{
  ...
  if ( this->__end_ < this->__cap_ ) {
    if ( __p == this->__end_ ) {
      ...
      std::__temp_value<value_type, _Allocator> __tmp( this->__alloc_, std::forward<_Args>( __args )... );
      __move_range( __p, this->__end_, __p + 1 );
    ...
    const_iterator __position, size_type __n, const_reference __x )
{
  ...
  if ( __n > 0 ) {
    ...
    if ( !std::__libcpp_is_constant_evaluated() && __n <= static_cast<size_type>( this->__cap_ - this->__end_ ) ) {
      ...
      std::__split_buffer<value_type, allocator_type&> __v( __recommend( size() + __n ), __p - this->__begin_,
                                                            this->__alloc_ );
      __v.__construct_at_end( __n, __x );
      __p = __swap_out_circular_buffer( __v, __p );
    }
...
Vector<_Tp, _Allocator>::__insert_with_sentinel( const_iterator __position, _InputIterator __first, _Sentinel __last )
{
  ...
  pointer __old_last = this->__end_;
  for ( ; this->__end_ != this->__cap_ && __first != __last; ++__first ) __construct_one_at_end( *__first );

  if ( __first == __last )
    (void)std::rotate( __p, __old_last, this->__end_ );
  else {
    std::__split_buffer<value_type, allocator_type&> __v( __alloc_ );
    auto __guard = std::__make_exception_guard(
        std::_AllocatorDestroyRangeReverse<allocator_type, pointer>( __alloc_, __old_last, this->__end_ ) );
    __v.__construct_at_end_with_sentinel( std::move( __first ), std::move( __last ) );
    std::__split_buffer<value_type, allocator_type&> __merged(
        __recommend( size() + __v.size() ), __off,
        __alloc_ );  // has `__off` positions available at the front
    std::__uninitialized_allocator_relocate( __alloc_, std::__to_address( __old_last ),
    ...
    std::__uninitialized_allocator_relocate( __alloc_, std::__to_address( __v.__begin_ ),
...
{
  if ( this->__begin_ == nullptr ) {
    if ( this->__end_ != nullptr || this->__cap_ != nullptr ) return false;
  } else {
    if ( this->__begin_ > this->__end_ ) return false;
    if ( this->__begin_ == this->__cap_ ) return false;
    if ( this->__end_ > this->__cap_ ) return false;
  }
  return true;
}
