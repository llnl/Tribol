...
class ElementNormal {
 public:
   ...
   * @brief Destructor
   */
  TRIBOL_HOST_DEVICE inline virtual ~ElementNormal() {}
   ...
   */
  TRIBOL_HOST_DEVICE inline virtual bool Compute( const RealT* x, const RealT* c, RealT* n, int num_nodes,
                                                  RealT& area ) const = 0;
};
...
class PalletAvgNormal : public ElementNormal {
 public:
   ...
   * @return Is face data OK?  true = yes; false = no
   */
  TRIBOL_HOST_DEVICE inline bool Compute( const RealT* x, const RealT* c, RealT* n, int num_nodes,
...
TRIBOL_HOST_DEVICE inline bool PalletAvgNormal::Compute( const RealT* x, const RealT* c, RealT* n, int num_nodes,
                                                         RealT& area ) const
{
  bool face_ok = true;
  area = 0.0;
...
TRIBOL_HOST_DEVICE inline bool ElementCentroidNormal::Compute( const RealT* x, const RealT* c, RealT* n, int num_nodes,
                                                               RealT& area ) const
{
  area = 0.0;
