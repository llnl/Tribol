...
bool PalletAvgNormal::Compute( const RealT* x, const RealT* c, RealT* n, int num_nodes, RealT& area ) const
{
  bool face_ok = true;
  area = 0.0;
...
bool QuadCentroidNormal::Compute( const RealT* x, const RealT* c, RealT* n, int num_nodes, RealT& area ) const
{
  area = 0.0;
