...
void TRIBOL_TEST_MESH_TestMesh_setup_contact_mesh_hex(TRIBOL_TEST_MESH_TestMesh* self, int numElemsX1, int numElemsY1,
                                                      int numElemsZ1, double xMin1, double yMin1, double zMin1,
                                                      double xMax1, double yMax1, double zMax1, int numElemsX2,
                                                      int numElemsY2, int numElemsZ2, double xMin2, double yMin2,
                                                      double zMin2, double xMax2, double yMax2, double zMax2,
                                                      double thetaMortar, double thetaNonmortar)
{
  tribol::TestMesh* SH_this = static_cast<tribol::TestMesh*>(self->addr);
  // splicer begin class.TestMesh.method.setup_contact_mesh_hex
  SH_this->setupContactMeshHex(numElemsX1, numElemsY1, numElemsZ1, xMin1, yMin1, zMin1, xMax1, yMax1, zMax1, numElemsX2,
                               numElemsY2, numElemsZ2, xMin2, yMin2, zMin2, xMax2, yMax2, zMax2, thetaMortar,
                               thetaNonmortar);
...
double* TRIBOL_TEST_MESH_TestMesh_get_x_bufferify(const TRIBOL_TEST_MESH_TestMesh* self,
                                                  TRIBOL_TEST_MESH_SHROUD_array* DSHC_rv)
{
  const tribol::TestMesh* SH_this = static_cast<const tribol::TestMesh*>(self->addr);
...
double* TRIBOL_TEST_MESH_TestMesh_get_y_bufferify(const TRIBOL_TEST_MESH_TestMesh* self,
                                                  TRIBOL_TEST_MESH_SHROUD_array* DSHC_rv)
{
  const tribol::TestMesh* SH_this = static_cast<const tribol::TestMesh*>(self->addr);
...
double* TRIBOL_TEST_MESH_TestMesh_get_z_bufferify(const TRIBOL_TEST_MESH_TestMesh* self,
                                                  TRIBOL_TEST_MESH_SHROUD_array* DSHC_rv)
{
  const tribol::TestMesh* SH_this = static_cast<const tribol::TestMesh*>(self->addr);
...
int* TRIBOL_TEST_MESH_TestMesh_get_mortar_face_connectivity_bufferify(const TRIBOL_TEST_MESH_TestMesh* self,
                                                                      TRIBOL_TEST_MESH_SHROUD_array* DSHC_rv)
{
  const tribol::TestMesh* SH_this = static_cast<const tribol::TestMesh*>(self->addr);
...
int* TRIBOL_TEST_MESH_TestMesh_get_nonmortar_face_connectivity_bufferify(const TRIBOL_TEST_MESH_TestMesh* self,
                                                                         TRIBOL_TEST_MESH_SHROUD_array* DSHC_rv)
{
  const tribol::TestMesh* SH_this = static_cast<const tribol::TestMesh*>(self->addr);
