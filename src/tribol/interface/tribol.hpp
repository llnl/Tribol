 ...
 */
int getElementBlockJacobians(IndexT cs_id, BlockSpace row_block, BlockSpace col_block, const ArrayT<int>** row_elem_idx,
                             const ArrayT<int>** col_elem_idx, const ArrayT<mfem::DenseMatrix>** jacobians);
