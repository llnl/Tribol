...
struct TestControlParameters {
  ...
  PolyInteg common_plane_rule;        ///< CommonPlane overlap integration rule used by the test.
  int common_plane_quadrature_order;  ///< Explicit CommonPlane multipoint integration order used by the test.
  RealT rate_penalty;
