...
class DataManager {
 public:
   ...
   */
  typename std::unordered_map<IndexT, T>::iterator begin() noexcept { return data_map_.begin(); }
   ...
   * @return std::unordered_map<IndexT, T>::iterator
   */
  typename std::unordered_map<IndexT, T>::iterator end() noexcept { return data_map_.end(); }
   ...
   */
  void clear() noexcept { data_map_.clear(); }
   ...
   */
  size_t size() noexcept { return data_map_.size(); }
