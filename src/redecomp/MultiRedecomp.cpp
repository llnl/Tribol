    ...
    : ghost_len_multiplier_{ ghost_len_multiplier }
{
  ...
  switch ( dim ) {
    case 2:
      switch ( method ) {
        case RCB:
          partitioner_ = std::make_unique<Partitioner2D>( std::make_unique<PartitionElements2D>(),
    ...
    case 3:
      switch ( method ) {
        case RCB:
          partitioner_ = std::make_unique<Partitioner3D>( std::make_unique<PartitionElements3D>(),
