...
class BisecTree {
 public:
   ...
   */
  BFSLevelIterator begin() { return all_nodes_.begin(); }
   ...
   */
  ConstBFSLevelIterator begin() const { return all_nodes_.begin(); }
   ...
   */
  BFSLevelIterator end() { return all_nodes_.end(); }
   ...
   */
  ConstBFSLevelIterator end() const { return all_nodes_.end(); }
