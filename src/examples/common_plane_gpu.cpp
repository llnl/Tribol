...
int runExample(int num_elems_1d)
{
  ...
  // create top mesh
  mfem::Mesh top_mesh = mfem::Mesh::MakeCartesian3D(num_elems_1d, num_elems_1d, 1, mfem::Element::Type::HEXAHEDRON, 1.0,
                                                    1.0, elem_height);
  ...
  tribol::ArrayT<tribol::IndexT, 2, tribol::MemorySpace::Host> host_top_conn(num_contact_elems, 4);
  int elem_ct = 0;
  ...
  tribol::ArrayT<tribol::IndexT, 2, tribol::MemorySpace::Host> host_bottom_conn(num_contact_elems, 4);
  elem_ct = 0;
  ...
  tribol::registerMesh(top_mesh_id, num_contact_elems, top_fe_space.GetNDofs(), top_conn.data(), tribol::LINEAR_QUAD,
                       top_x_coords_ptr, top_y_coords_ptr, top_z_coords_ptr, MSPACE);
  constexpr tribol::IndexT bottom_mesh_id = 1;
  tribol::registerMesh(bottom_mesh_id, num_contact_elems, bottom_fe_space.GetNDofs(), bottom_conn.data(),
                       tribol::LINEAR_QUAD, bottom_x_coords_ptr, bottom_y_coords_ptr, bottom_z_coords_ptr, MSPACE);
  ...
  tribol::registerNodalVelocities(top_mesh_id, top_x_velocity_ptr, top_y_velocity_ptr, top_z_velocity_ptr);
  ...
  tribol::registerNodalVelocities(bottom_mesh_id, bottom_x_velocity_ptr, bottom_y_velocity_ptr, bottom_z_velocity_ptr);
  ...
  tribol::registerNodalResponse(top_mesh_id, top_x_force_ptr, top_y_force_ptr, top_z_force_ptr);
  ...
  tribol::registerNodalResponse(bottom_mesh_id, bottom_x_force_ptr, bottom_y_force_ptr, bottom_z_force_ptr);
  ...
  tribol::registerCouplingScheme(cs_id, top_mesh_id, bottom_mesh_id, tribol::SURFACE_TO_SURFACE, tribol::NO_CASE,
                                 tribol::COMMON_PLANE, tribol::FRICTIONLESS, tribol::PENALTY, tribol::BINNING_BVH,
                                 EXEC);
