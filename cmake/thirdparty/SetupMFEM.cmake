...
tribol_assert_path_exists( ${MFEM_DIR} )
...
if(MFEM_FOUND)
    ...
    foreach(_include_flag ${mfem_tpl_inc_flags})
        ...
        if(_pos EQUAL 0)
            ...
            if(IS_ABSOLUTE "${_include_dir}" AND NOT IS_DIRECTORY "${_include_dir}")
                message(STATUS "Ignoring nonexistent MFEM dependency include directory: ${_include_dir}")
            else()
