...
"""
 ...
 description:
  This script takes a Tribol install and source directory and checks to see
...
def main():
    ...
    install_headers = get_headers_from(os.path.join(install_dir, "include", "tribol"))
    src_headers = get_headers_from(os.path.join(src_dir, "tribol"))
