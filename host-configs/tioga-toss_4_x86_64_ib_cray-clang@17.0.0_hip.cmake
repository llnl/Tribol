...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS2/smithdev/libs/serac/toss_4_x86_64_ib_cray/2024_10_01_15_45_47/spack/lib/spack/env/clang/clang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS2/smithdev/libs/serac/toss_4_x86_64_ib_cray/2024_10_01_15_45_47/spack/lib/spack/env/clang/clang++" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/usr/WS2/smithdev/libs/serac/toss_4_x86_64_ib_cray/2024_10_01_15_45_47/spack/lib/spack/env/clang/flang" CACHE PATH "")

else()

  set(CMAKE_C_COMPILER "/opt/rocm-5.7.1/llvm/bin/amdclang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/opt/rocm-5.7.1/llvm/bin/amdclang++" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/opt/rocm-5.7.1/llvm/bin/amdflang" CACHE PATH "")
...
set(MPI_C_COMPILER "/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.27-rocmcc-5.7.1/bin/mpicc" CACHE PATH "")

set(MPI_CXX_COMPILER "/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.27-rocmcc-5.7.1/bin/mpicxx" CACHE PATH "")

set(MPI_Fortran_COMPILER "/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.27-rocmcc-5.7.1/bin/mpif90" CACHE PATH "")
...
set(HIP_ROOT_DIR "/opt/rocm-5.7.1/hip" CACHE PATH "")

set(CMAKE_HIP_COMPILER "/opt/rocm-5.7.1/llvm/bin/clang++" CACHE FILEPATH "")
...
set(TPL_ROOT "/usr/WS2/smithdev/libs/serac/toss_4_x86_64_ib_cray/2024_10_01_15_45_47/clang-17.0.0" CACHE PATH "")

set(AXOM_DIR "${TPL_ROOT}/axom-0.9.0.1-e3mw22b6kayepwgdt56bigytlodcj67y" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.7.0.1-c2zdyi4i5oplimxje3zqujjcqo2zmqqi" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.02.0-koswlfhrwo2bpgbv2rrkoqaaslqanzs4" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.02.0-yurzhcbobbthtsdpsoiidffxth5oe2ft" CACHE PATH "")
...
set(TRIBOL_ENABLE_CODE_CHECKS OFF CACHE BOOL "")
